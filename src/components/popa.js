...
function Note({setNote}){
    ...
    return(
        <div className=" awan pt-3 ps-5 pe-5 pb-3 text-start">
            <div className="d-flex flex-row justify-content-between">
            <h5 id="app">Book Appointment Now</h5>
            <i id="cross" className="fas fa-times" onClick={() => setNote(false)}></i></div>
...
07 Aug - 11:30 PM | <span id="navy">Change Date & Time</span></p>
            </div>
