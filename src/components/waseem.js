...
import './waseem.css';
import waseem from '../assests/images/waseem.png';
...
<img id="salman" src={waseem}/>
<div className="d-flex flex-column gap-0">
    <p id="salu"> Dr. Waseem Hassan</p>
    <p id="riaz"><span id="green"><i className="fas fa-circle-check"></i>PMDC Verified</span><br/>MBBS, MSc (Pain Management)</p>
<div className="d-flex flex-row ms-5 ps-5 gap-5">
    <p id="riew">Reviews<br/><i className="review fas fa-thumbs-up"> 2</i></p>
    <p id="Experience" className="ms-5 ps-5">Experience<br/><strong>28 Yrs</strong></p>
