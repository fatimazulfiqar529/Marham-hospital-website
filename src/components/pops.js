...
function Msg({setLook}){
    const [Popup,setPopup]=useState(false);
    return(
        <div className="bolo pt-3 ps-5 pe-5 pb-3 text-start">
<div className="d-flex flex-row justify-content-between">
            <h5 id="app">Book Appointment Now</h5>
            <i id="cross" className="fas fa-times" onClick={() => setLook(false)}></i>
            </div>    
...
07 Aug - 03:00 PM | <span id="navy">Change Date & Time</span></p>
            </div>
